...
static uint8_t const base64_table[65] =
 ...
 */
char *
base64_encode(void const *buf, size_t len, size_t *out_len, int max_line_len)
{
    uint8_t *out, *pos;
    uint8_t const *end, *in;
    size_t olen;
    int line_len;
 ...
 */
void *
base64_decode(char const *buf, size_t len, size_t *out_len)
{
